...
| 6 | POST | `/api/requests` | `{"requesterName":"x"}` | 400 | 404 | ✅ |
...
|---|---|---|
| 1 | POST เพิ่มคำร้องใหม่ | เพิ่มคำร้องสำเร็จ / ได้คำร้องใหม่ 1 รายการ |
| 2 | GET ดูรายการ — เห็นคำร้องใหม่ไหม | พบคำร้องที่เพิ่มใหม่ในรายการ |
| 3 | Ctrl+C ปิดเซิร์ฟเวอร์ แล้วเปิดใหม่ | เซิร์ฟเวอร์หยุดทำงาน แล้วเริ่มทำงานใหม่ได้ |
| 4 | GET ดูรายการอีกครั้ง — คำร้องยังอยู่ไหม | คำร้องเดิมยังอยู่หลัง Restart Server |

## สรุปผล

- ผ่าน 9 / 9 (+ Challenge 1 / 3)
- รายการที่ไม่ผ่านและสาเหตุ:

## Screenshot ที่แนบ

- [ ✔️ ] `images/postman-get-200.png`
- [ ✔️ ] `images/postman-post-201.png`
- [ ✔️ ] `images/terminal-logger.png`
